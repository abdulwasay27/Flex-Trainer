namespace Database_Project_GymTrainer
{
    partial class Member_SignUp
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.member_signup_pw = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
            this.member_signup_name = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
            this.member_signup_email = new ComponentFactory.Krypton.Toolkit.KryptonTextBox();
            this.pictureBox2 = new System.Windows.Forms.PictureBox();
            this.member_signup_gym = new ComponentFactory.Krypton.Toolkit.KryptonComboBox();
            ...
            this.Controls.Add(this.member_signup_obj);
            this.Controls.Add(this.label5);
            this.Controls.Add(this.member_signup_gym);
            this.Controls.Add(this.label8);
            this.Controls.Add(this.member_signup_email);
            this.Controls.Add(this.kryptonButton4);
            this.Controls.Add(this.kryptonButton1);
            this.Controls.Add(this.member_signup_pw);
            this.Controls.Add(this.member_signup_name);
        ...
        private ComponentFactory.Krypton.Toolkit.KryptonTextBox member_signup_pw;
        private ComponentFactory.Krypton.Toolkit.KryptonTextBox member_signup_name;
        private ComponentFactory.Krypton.Toolkit.KryptonTextBox member_signup_email;
        private System.Windows.Forms.PictureBox pictureBox2;
        private ComponentFactory.Krypton.Toolkit.KryptonComboBox member_signup_gym;
